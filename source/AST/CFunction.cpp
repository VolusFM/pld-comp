...
CFunction::CFunction(const CProg* prog, string name, CType type,
		vector<CParameter>& parameters_, CInstructions& block_) :
		prog(prog), name(name), type(type), tos(
				prog != nullptr ? &prog->tos : nullptr) {
