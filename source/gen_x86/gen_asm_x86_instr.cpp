...
void IRInstr::gen_asm_x86(ostream& o) const {
    ...
    */
    ...
    case op_ldconst_array:
        o << "  movl  " << params[1] << ", " << tos.get_address_x86_array(params[0])<< "\n";
        break;
    ...
    case op_call :
        ...
        for (auto it = params.begin()+2 ; it != params.end() ; ++it) {
            o << "  movl " << tos.get_address_x86(*it) << ", " << registerName[index] << "\n";
            if (++index==6) break;
        }
        }
        o << "  call  " << params[0] << "\n";
        ...
        break;
    case op_return:
        o << "  movl  " << (params[0].at(0) == '$' ? params[0] : tos.get_address_x86(params[0])) << ", %eax\n";
        break;
